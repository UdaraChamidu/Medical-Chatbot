import base64   # helps to encode images in base64 format
import requests # to API calls
import io       # 
from PIL import Image           # open an verify images
from dotenv import load_dotenv  # creating and store secret API keys and environmental variables
import os       # to access environmental variables
import logging  # handling logging
from groq import Groq

logging.basicConfig(level=logging.INFO)
logger = logging.getLogger(__name__)

load_dotenv()  # for easy accessing

# go to groq cloud and copy and paste the url for chat completion
# postman also can be used
GROQ_API_URL = "https://api.groq.com/openai/v1/chat/completions"
# create an API key copy the link and paste it in .env file
# access the API
...
def process_image(image_path, query):
    try:
        ...
        def make_api_request(model):
            ...
            return response
        # copy from the qroq cloud website
